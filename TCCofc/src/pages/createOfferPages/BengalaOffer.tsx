    ...
    async function postChild() {
        await axios.post(`http://localhost:3344/products/bengala`, {
            ...
            toast({
                ...
                render: () => (
                    <Stack bg="green.400" align="center" direction="column" p="2vh" borderRadius="30px" spacing={2}>
                        <Text fontFamily="atkinson" color="white" noOfLines={1} fontSize={{base:"22px", md:"20px"}}>Bengala criada com sucesso!</Text>
                    </Stack>
                )
            })
        }).catch((error) => {
                        ...
                        <Stack spacing={3} align="center">
                            ...
                            <Flex w='100%' h='fit-content' align='center' direction={{base:'column' ,md:'row'}}>
                                ...
                                <FormLabel w="100%" fontSize={{base:"20px", md:"18px"}}>Cores
                                    ...
                                    <PopoverTrigger><Input onChange={handleChange} name='color' color="gray" fontSize={{base:"20px", md:"18px"}}/></PopoverTrigger>
