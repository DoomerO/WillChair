...
const Contact = () => {
  return (
    <Box w="100%" h="100%">
      <HeaderToggle/>
      <Flex w="100%" h="100%" pt="5%" direction="row" textAlign="center">
        <Box  p="6" shadow="md" w="40%" bg={colors.veryLightBlue} _dark={{bg : colors.veryLightBlue_Dark}}>
      ...
      <Stack w="60%" h="100%"  textAlign="center" direction="column" bg={colors.bgWhite} _dark={{bg : colors.bgWhite_Dark}}>
