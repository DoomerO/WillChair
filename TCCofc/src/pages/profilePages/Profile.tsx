    ...
    <Box w="100%" h="100%">
      <HeaderToggle/>
        <Flex direction="column" align="center" w="100%" bg={colors.bgWhite} h="fit-content" pt="4.6%" _dark={{bg : colors.bgWhite_Dark}}>
          <Flex direction="row" w="90%" h="fit-content" pb="5vh">
              ...
              <Stack w="80%">
                ...
                <SimpleGrid spacing={3} fontSize={{base:"24px", sm:"20px"}}>
                    <Flex direction="row">
                    ...
                    <Flex direction="row">
                      ...
                      <Text fontFamily="atkinson" color={colors.colorFontBlue}>{(user.user_CEP || user.user_houseNum) ? user.user_CEP + ", " +user.user_houseNum+ ", " +user.user_comp : "Endereço não disponibilizado."}</Text>
                    </Flex>
                </SimpleGrid>
              </Stack>
          </Flex>
        ...
        <Flex bg={colors.veryLightBlue} h="fit-content" direction="column" align="center" pb="5vh" _dark={{bg : colors.veryLightBlue_Dark}}>
          <Heading as="h1" mt="3%" fontSize={{base: "36px", sm: "30px"}} color={colors.colorFontDarkBlue} mb="2%" _dark={{color: colors.colorFontDarkBlue_Dark}}>Comentários sobre {user.user_name}</Heading>
        ...
        <Flex bg={colors.bgWhite} h="fit-content" direction="column" align="center" pb="5vh" _dark={{bg : colors.bgWhite_Dark}}>
          <Heading as="h1" mt="3%" fontSize={{base: "36px", sm: "30px"}} color={colors.colorFontDarkBlue} mb="2%" _dark={{color: colors.colorFontDarkBlue_Dark}}>Ofertas de {user.user_name}</Heading>
