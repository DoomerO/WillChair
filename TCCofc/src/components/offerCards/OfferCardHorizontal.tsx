...
const OfferCardHorizontal = ({img, title, value, desc}: HorizontalOfferCard) => {
    return (
            ...
            <Stack w={{base:"100%" ,sm:"77.5%"}} h={{base:"50%", sm:"100%"}}>
                ...
                <CardFooter>
                        <Flex w="100%" align="center" direction="row">
                            <Button colorScheme="linkedin" variant="solid" fontSize={{base:"22px", sm:"20px"}}>Ver mais</Button>
                            <Spacer />
