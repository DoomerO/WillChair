...
const MuletaOffer = () => {
    ...
    return (
        (loading) ? <Loading/> : <Box w="100%" h="100%">
            ...
            <Flex w='100%' bg={colors.veryLightBlue} h={{ base: "200vh", md: '173vh' }} align='center' direction='column' _dark={{ bg: colors.veryLightBlue_Dark }} pb={{ base: "5vh", md: "none" }}>
                        ...
                        <Stack spacing={3} align="center">
                            ...
                            <Flex w='100%' h='fit-content' align='center' direction={{ base: 'column', md: 'row' }}>
                                <FormLabel w="100%" fontSize={{ base: "20px", md: "18px" }}>Tipo de Muleta<Select name='type' color="gray"
                                    fontSize={{ base: "17px", md: "18px" }} onChange={handleChangeSelect}>
