...
const ChatSquare = ({ chat_id, user_id, isOwner, end }: chatSquareProps) => {
    ...
    return (
        <Flex w={{ base: "100%", md: "100%" }} bg="#f7f7f7" _dark={{ bg: colors.veryLightBlue_Dark }} h="100%" direction="column" justifyContent="center" align="center">
                ...
                <Menu>
                    ...
                    <MenuList fontSize={{ base: "20px", md: "15px" }} w="100vw">
                        ...
                        <Link to={`/offer/${other.ofr_id}`}><MenuItem onClick={() => {
                            ...
                            <Flex direction="row" align="center" w={{ base: "100%", md: "95%" }}>Ir para a oferta<Spacer /><MdOutlineLocalOffer size="6%" /></Flex>
                        </MenuItem></Link>
            ...
            <Flex w="100%" pr="2%" pl="2%" minH={{ base: "76vh", md: "70%" }} maxH={{ base: "76vh", md: "70%" }} overflowY="scroll" ref={messageOverFlow} css={{
                '&::-webkit-scrollbar': {
                    width: '4px',
                },
